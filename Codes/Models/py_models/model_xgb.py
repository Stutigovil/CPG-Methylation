...
class XGBModel:
    def __init__(self, n_estimators=100, random_state=42):
        self.model = XGBClassifier(n_estimators=n_estimators, random_state=random_state, use_label_encoder=False, eval_metric='logloss')
    ...
    def hyperparameter_tuning(self, X, y, param_grid, cv=10):
        X_scaled = self.scaler.fit_transform(X)
        grid_search = GridSearchCV(estimator=self.model, param_grid=param_grid, cv=cv, scoring='roc_auc', n_jobs=-1)
